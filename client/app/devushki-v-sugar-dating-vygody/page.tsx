  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        ...
        <meta
          property="og:title"
          content="Девушки и sugar-формат: выгоды, безопасность и как всё устроено"
        />
        <meta
          property="og:description"
          content="Прозрачные ожидания, менторство и развитие, защита данных и границ. Полезные скрипты и FAQ. 18+."
        />
        <meta property="og:url" content="https://example.com/devushki-v-sugar-dating-vygody" />

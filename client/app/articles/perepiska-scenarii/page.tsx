...
export default function MessagingScenariosPage() {
  const year = new Date().getFullYear();

  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Переписка: первые сообщения и переход к встрече | 18+</title>
        <meta
          name="description"
          content="Готовые сценарии первых сообщений, структура диалога, анти-фразы и как мягко перейти к офлайн-встрече. Формат взрослых отношений win-win, без интим-услуг."
        />
        <link rel="canonical" href="https://blow.ru/perepiska-scenarii" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Переписка: первые сообщения и переход к встрече" />
        <meta
          property="og:description"
          content="Шаблоны первых сообщений, корректная коммуникация и безопасный переход к встрече."
        />
      </Head>
        ...
        <div className="w-full">
          ...
          {/* <nav aria-label="Внутренние ссылки" className="text-sm sm:text-base mt-6">
            <p className="flex flex-wrap gap-3">
              ...
              <span>·</span>
              <NextLink href="/silnaya-anketa-soderzhanki" className="underline hover:text-primary">
                Сильная анкета содержанки
              </NextLink>
            </p>
          </nav> */}
        </div>

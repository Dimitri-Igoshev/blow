...
export default function SponsorProfilePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Профиль спонсора: структура, примеры и этикет | 18+</title>
        <meta
          name="description"
          content="Что писать спонсору в анкете: цели, образ жизни, формат встреч, границы и конфиденциальность. Примеры, ошибки и правила этикета."
        />
        <link rel="canonical" href="https://blow.ru/profil-sponsora" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Профиль спонсора: структура, примеры и этикет" />
        <meta
          property="og:description"
          content="Структура анкеты спонсора, готовые примеры, частые ошибки и корректная коммуникация на старте."
        />
      </Head>
        ...
        <div className="w-full">
          ...
          <section className="space-y-4 mt-4">
            ...
            <div className="text-sm sm:text-base space-y-3">
              <p>
                <strong>Что включить в «О себе»?</strong> Коротко: сфера, увлечения, занятость, когда удобны встречи.
              </p>
              <p>
                <strong>Где уместно обсуждать условия поддержки?</strong> После очной встречи и взаимной симпатии.
              </p>
              <p>
                <strong>Как подчеркнуть уважение к приватности?</strong> Пропишите это в профиле и соблюдайте договорённости.
              </p>
            </div>
          </section>

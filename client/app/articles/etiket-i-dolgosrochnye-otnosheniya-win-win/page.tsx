...
export default function EtiquetteLongtermPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Этикет win-win: долгосрочные отношения без выгорания | 18+</title>
        <meta
          name="description"
          content="Роли, обратная связь по методу SBI, границы и конфиденциальность. Планирование совместных активностей и корректное завершение."
        />
        <link rel="canonical" href="https://example.com/etiket-i-dolgosrochnye-otnosheniya-win-win" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Этикет win-win: долгосрочные отношения" />
        <meta property="og:description" content="Как не выгореть и развиваться вместе: правила общения и регулярные сверки." />
      </Head>
      ...
      <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
        <div className="w-full">
          ...
          <p className="text-sm sm:text-base mt-4">
            <strong>18+</strong> Только добровольные отношения взрослых людей. Уважение границ и конфиденциальность — базовые правила.
          </p>

          <section className="space-y-4 mt-9">
            <h2 className="text-xl sm:text-2xl font-semibold">Роли и ожидания</h2>
            <p className="text-sm sm:text-base">
              Определите, кто планирует встречи, бронирует билеты/курсы, как согласуются расписания и бюджет. Пересматривайте роли раз в месяц.
            </p>
          </section>
          ...
          <section className="space-y-4 mt-4">
            ...
            <p className="text-sm sm:text-base">
              Не публикуйте совместные фото/истории без согласия; проверяйте метаданные изображений. Доступ к общим папкам/календарям — по согласию.
            </p>
          </section>
          ...
          <section className="space-y-4 mt-4">
            ...
            <p className="text-sm sm:text-base">
              Если формат перестал подходить — честно проговорите причины, поблагодарите за время и опыт, при желании оставьте дверь открытой для будущих проектов.
            </p>
          </section>

...
export default function StrongSugarProfilePage() {
  const year = new Date().getFullYear();

  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Сильная анкета содержанки: примеры и шаблоны | 18+</title>
        <meta
          name="description"
          content="Как оформить анкету содержанки: фото, описание, ожидания и границы. Шаблоны, анти-ошибки и чек-лист для высокого отклика."
        />
        <link rel="canonical" href="https://blow.ru/silnaya-anketa-soderzhanki" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Сильная анкета содержанки: примеры и шаблоны" />
        <meta
          property="og:description"
          content="Фото, описание, ожидания и верификация: что работает лучше всего. Чек-лист и анти-ошибки."
        />
      </Head>

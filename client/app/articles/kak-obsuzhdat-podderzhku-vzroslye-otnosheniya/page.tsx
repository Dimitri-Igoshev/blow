...
export default function SupportTalkPage() {
  const year = new Date().getFullYear();

  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Как обсуждать поддержку: подарки, обучение, менторство | 18+</title>
        <meta
          name="description"
          content="Скрипты разговора о поддержке без неловкости: обучение, культурные мероприятия, путешествия, наставничество. Прозрачные договорённости, 18+."
        />
        <link rel="canonical" href="https://blow.ru/kak-obsuzhdat-podderzhku-vzroslye-otnosheniya" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Как обсуждать поддержку: подарки, обучение, менторство" />
        <meta property="og:description" content="Этичные формулировки и сценарии обсуждения поддержки в формате win-win." />
      </Head>
      ...
      <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
        <div className="w-full">
          ...
          <p className="text-sm sm:text-base mt-4">
            <strong>18+</strong> Добровольные взрослые отношения формата win-win. Избегайте незаконных формулировок и двусмысленностей.
          </p>

          <section className="space-y-4 mt-9">
            <h2 className="text-xl sm:text-2xl font-semibold">Рамка «цели → формат → правила»</h2>
            <p className="text-sm sm:text-base">
              Начинайте с целей (обучение, культурные проекты), затем формат (частота встреч, активности), завершайте правилами (границы, конфиденциальность).
            </p>
          </section>
          ...
          <section className="space-y-3 mt-2">
            ...
            <p className="text-sm sm:text-base">
              Кратко перечислите: частота встреч, тип активностей, форматы поддержки, границы, конфиденциальность. Сверка раз в 2–4 недели.
            </p>
          </section>
          ...
          {/* <nav aria-label="Внутренние ссылки" className="text-sm sm:text-base mt-6">
            <p className="flex flex-wrap gap-3">
              ...
              <span>·</span>
              <NextLink href="/krasnye-flagi-i-moshenniki-v-sugar-dating" className="underline hover:text-primary">Красные флаги</NextLink>
              <span>·</span>

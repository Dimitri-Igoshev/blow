...
export default function MoscowRfRulesPage() {
  const year = new Date().getFullYear();

  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Москва и РФ: правила, безопасность и различия формата | 18+</title>
        <meta
          name="description"
          content="Как знакомиться в Москве и регионах: этикет, безопасность, корректные договорённости и приватность. Формат взрослых отношений win-win, без интим-услуг."
        />
        <link rel="canonical" href="https://blow.ru/pravila-bezopasnost-moskva-rf" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Москва и РФ: правила, безопасность и различия формата" />
        <meta
          property="og:description"
          content="Контекст мегаполиса и регионов, рекомендации по безопасности и этикету, корректные финансовые разговоры."
        />
      </Head>

...
https://blow.ru                              Редакция от 30.06.2025
...
Фактический адрес: An der Spreeschanze 10 , 13599 , Berlin , Germany
...
export default function OfferPage() {
  return (
    <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
      <h1 className="text-[36px] font-semibold">Публичная оферта</h1>

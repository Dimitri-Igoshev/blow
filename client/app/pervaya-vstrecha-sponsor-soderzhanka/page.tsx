...
export default function FirstMeetingPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Первая встреча: безопасность, этикет и сценарий | 18+</title>
        <meta
          name="description"
          content="Гайд по первой встрече: безопасная локация, тайм-бокс 60–90 минут, темы разговора и чек-лист. Формат взрослых отношений win-win, без интим-услуг."
        />
        <link rel="canonical" href="https://blow.ru/pervaya-vstrecha-sponsor-soderzhanka" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Первая встреча: безопасность, этикет и сценарий" />
        <meta property="og:description" content="Пошаговый сценарий и безопасность на первой встрече. 18+." />
      </Head>
      ...
      <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
        <div className="w-full">
          ...
          <p className="text-sm sm:text-base mt-4">
            <strong>18+</strong> Материал для совершеннолетних. Речь о добровольных отношениях формата win-win. Мы не описываем и не поощряем интим-услуги.
          </p>
          ...
          <section className="space-y-4 mt-4">
            ...
            <p className="text-sm sm:text-base">
              Выбирайте публичные и светлые места: кафе, лобби-бар отеля, галерея. Оптимальный тайм-бокс — <strong>60–90 минут</strong>, чтобы легко завершить встречу без неловкости.
            </p>
          </section>
          ...
          <section className="space-y-4 mt-4">
            ...
            <p className="text-sm sm:text-base">
              На первом этапе избегайте наличных и переводов. Уместнее говорить о <strong>подарках-впечатлениях</strong> и обучении как о легальных и этичных форматах поддержки.
            </p>
          </section>
      ...
      <footer className="bg-gray dark:bg-black w-full">
        <div className="bg-dark rounded-t-[50px] px-3 sm:px-12 py-[28px] grid grid-cols-1 sm:grid-cols-3 text-white items-center text-xs sm:text-base">
          ...
          <div className="text-xs mt-7 sm:mt-0 flex flex-wrap items-center justify-center sm:justify-end gap-6">
            ...
            <NextLink href={ROUTES?.OFFER ?? ROUTES.OFFER} className="underline cursor-pointer hover:text-primary text-nowrap">Договор оферта</NextLink>
            <NextLink href={ROUTES.RULES} className="underline cursor-pointer hover:text-primary text-nowrap -mt-2 sm:mt-0">Правила</NextLink>
          </div>
        </div>
      </footer>
    </div>

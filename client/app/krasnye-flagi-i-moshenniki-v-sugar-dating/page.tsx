...
export default function RedFlagsPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <Head>
        <title>Красные флаги и мошенники: как защититься | 18+</title>
        <meta
          name="description"
          content="Типовые схемы, поведенческие красные флаги и пошаговый план защиты в формате знакомств win-win. Жалоба модерации, 2FA, безопасность."
        />
        <link rel="canonical" href="https://example.com/krasnye-flagi-i-moshenniki-v-sugar-dating" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Красные флаги и мошенники: как защититься" />
        <meta property="og:description" content="Риски и защита: спешка, давление, фишинг-ссылки, 'верификационные' платежи. 18+." />
      </Head>
      ...
      <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
        <div className="w-full">
          ...
          <p className="text-sm sm:text-base mt-4">
            <strong>18+</strong> Материал о безопасности. Отношения только добровольные, без нарушений закона и правил площадки.
          </p>

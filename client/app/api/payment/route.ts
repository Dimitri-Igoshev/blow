...
export async function POST(req: NextRequest) {
  try {
    ...
    const password = 'c2e08d259f7c5754c425c58ad89c97e3552fcb2407840aef23aa44379d2edc8e';
    ...
    return new Response(JSON.stringify({ message: 'Ошибка при отправке данных' }), { status: 500 });
  }
}
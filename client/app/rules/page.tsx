...
const rulesText = `
BLOW.RU — сайт для изысканных знакомств.
...
Особые замечания:
- Разрешён BDSM-контент (без жёстких практик).
- Мужчинам разрешено предлагать вирт за вознаграждение.
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <div className="flex w-full flex-col px-3 md:px-9 pt-[84px] gap-6 pb-[50px]">
        <h1 className="text-[36px] font-semibold mt-3 sm:mt-9">Правила сайта</h1>
